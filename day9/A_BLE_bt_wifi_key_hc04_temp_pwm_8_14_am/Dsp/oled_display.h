...
//      has_person  - 有人/无人(1=有人, 0=无人)，由app_task1采集后直接传入
//      temp        - 温度整数部分，由app_task1采集后直接传入
...
#define IDX_HAN_GOU   25  // √ (连接成功标记)
#define IDX_HAN_YOU   26  // 有
#define IDX_HAN_REN   27  // 人
#define IDX_HAN_WU    28  // 无
#define IDX_HAN_DEGREE 29 // ° (度数符号)
#define IDX_HAN_GANG   30 // 刚
